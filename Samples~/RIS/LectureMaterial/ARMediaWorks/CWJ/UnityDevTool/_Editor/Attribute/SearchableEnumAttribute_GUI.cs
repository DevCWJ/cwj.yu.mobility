...
namespace CWJ.EditorOnly
{
    ...
    /// </summary>
    public class SearchableEnumAttribute_GUI : PopupWindowContent
    {
        #region -- Constants --------------------------------------------------
        ...
        {
            SearchableEnumAttribute_GUI win = 
                new SearchableEnumAttribute_GUI(options, current, onSelectionMade);
        ...
        private SearchableEnumAttribute_GUI(string[] names, int currentIndex, Action<int> onSelectionMade)
        {
        ...
        {
            int entriesLength = list.Entries.Count;

            Rect contentRect = new Rect(0, 0,
                scrollRect.width - GUI.skin.verticalScrollbar.fixedWidth,
                entriesLength * ROW_HEIGHT);
