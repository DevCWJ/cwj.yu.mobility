...
//            list.elementHeight = Restore_EditorGUI.kSingleLineHeight * 2 + Restore_EditorGUI.kControlVerticalSpacing + kExtraSpacing;
//        }

//        protected virtual void DrawEventHeader(Rect headerRect)
//        {
//            headerRect.height = Restore_EditorGUI.kSingleLineHeight;
...
//                    {
//                        buttonContent = Restore_EditorGUI.mixedValueContent;
//                    }
//                    else
//                    {
...
//            rect.height = Restore_EditorGUI.kSingleLineHeight;
//            rect.y += 2;
...
//            goRect.y += EditorGUIUtility.singleLineHeight + Restore_EditorGUI.kControlVerticalSpacing;

//            Rect functionRect = rect;
//            functionRect.xMin = goRect.xMax + Restore_EditorGUI.kSpacing;

//            Rect argRect = functionRect;
//            argRect.y += EditorGUIUtility.singleLineHeight + Restore_EditorGUI.kControlVerticalSpacing;
...
//                if (targetObjectType.IsArray || targetObjectType.IsGenericList())
