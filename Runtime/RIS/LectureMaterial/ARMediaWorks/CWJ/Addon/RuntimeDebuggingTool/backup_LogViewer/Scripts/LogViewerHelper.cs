...
namespace CWJ.RuntimeDebugging
{
    ...
    public static class LogViewerHelper
    {
        ...
        static LogViewerHelper()
        {
            ...
            HashSet<Assembly> assemblies = new HashSet<Assembly> { Assembly.GetAssembly(typeof(LogViewerHelper)) };
            try
            {
        ...
        public static void LogSystemInfo()
        {
            ...
            stringBuilder.Append("Image Effects: ").Append(
...
SystemInfo.supportsImageEffects
            ...
            stringBuilder.Append("RenderToCubemap: ").Append(
#if UNITY_2019_1_OR_NEWER
                true
#else
SystemInfo.supportsRenderToCubemap
        ...
        private static void AddCommand(string command, string description, MethodInfo method, object instance = null)
        {
            ...
            if (isMethodValid)
            {
                ...
                for (int i = 0; i < parameterTypes.Length; i++)
                {
                    ...
                    if (!typeReadableNames.TryGetValue(type, out string typeName))
                        typeName = type.Name;
                ...
                {
                    if (!typeReadableNames.TryGetValue(returnType, out string returnTypeName))
        ...
        public static void ExecuteCommand(string command)
        {
            ...
            if (!methods.TryGetValue(commandArguments[0], out ConsoleMethodInfo methodInfo))
            ...
            else
            {
                ...
                for (int i = 0; i < methodInfo.parameterTypes.Length; i++)
                {
                    ...
                    if (!parseFunctions.TryGetValue(parameterType, out ParseFunction parseFunction))
                    {
