...
namespace CWJ.EditorOnly
{
    ...
    public class SearchableEnumAttribute_Editor : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if (property.propertyType != SerializedPropertyType.Enum /*!= "Enum"*/)
            {
            ...
            if (DropdownButton(id, position, buttonText))
            {
                ...
                SearchableEnumAttribute_GUI.Show(position, property.enumDisplayNames,
