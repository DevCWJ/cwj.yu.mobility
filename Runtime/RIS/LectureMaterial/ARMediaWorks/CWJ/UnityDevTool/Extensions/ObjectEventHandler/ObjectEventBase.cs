namespace CWJ
{
    //public interface IObjEventHandlerBase
    //{
    //    UnityEvent Enable { get; set; }

    //    UnityEvent Disable { get; set; }
    ...
    //public class ObjectEventBase:MonoBehaviour, IObjEventHandlerBase
    //{
    ...
    //    private void OnCollisionExit2D(Collision2D other) => CollisionExit2D?.Invoke(other);
    ...
    //    UnityEvent IObjEventHandlerBase.Enable { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
    //    UnityEvent IObjEventHandlerBase.Disable { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
    //}
}