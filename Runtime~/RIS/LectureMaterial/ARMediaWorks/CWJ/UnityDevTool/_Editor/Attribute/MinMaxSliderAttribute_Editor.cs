...
namespace CWJ.EditorOnly
{
	...
	public class MinMaxSliderAttribute_Editor : PropertyDrawer
	{
		...
		public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
		{
			...
			else
			{
				...
				if (minProperty.propertyType == SerializedPropertyType.Float)
				{
					...
					minimum = SnapAttribute_Editor.Snap(minimum, slider.SnapValue);
					maximum = SnapAttribute_Editor.Snap(maximum, slider.SnapValue);
				...
				else if (minProperty.propertyType == SerializedPropertyType.Integer)
				{
					...
					var min = Mathf.RoundToInt(SnapAttribute_Editor.Snap(minimum, slider.SnapValue));
					var max = Mathf.RoundToInt(SnapAttribute_Editor.Snap(maximum, slider.SnapValue));
