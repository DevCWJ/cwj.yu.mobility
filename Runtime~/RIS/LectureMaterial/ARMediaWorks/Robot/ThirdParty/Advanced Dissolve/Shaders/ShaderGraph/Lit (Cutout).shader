Shader "Amazing Assets/Advanced Dissolve/Shader Graph/Lit (Cutout)"
{
    ...
    SubShader
    {
        ...
        int _PassValue;
            ...
            void AdvancedDissolveShaderGraphFunction_float(float2 UV, float3 PositionOS, float3 PositionWS, float3 PositionWS_Absolut, float3 NormalOS,
                                                            float3 NormalWS, float Custom_Cutout, float4 Custom_Color, out float Value)
            {
                Value = 0;
            }
            ...
            void SG_AdvancedDissolve_58cc1ed7edc36664e85cbe55fd29d527_float(float Vector1_9E44E7D0, float4 Color_d37717e22d9845eeb5507ed0b661e197,
                                  Bindings_AdvancedDissolve_58cc1ed7edc36664e85cbe55fd29d527_float IN, out float Out_3)
            {
                ...
                AdvancedDissolveShaderGraphFunction_float((_UV_0af11090dff4968fbefbff780ab3f959_Out_0.xy), IN.ObjectSpacePosition, IN.WorldSpacePosition,
                         IN.AbsoluteWorldSpacePosition, IN.ObjectSpaceNormal, IN.WorldSpaceNormal, _Property_2254a3efc4fcf082bc34b2ce5b131975_Out_0,
                         _Property_6d35f866e3e7457cb788755ca206532e_Out_0,
                         _AdvancedDissolveShaderGraphFunctionCustomFunction_18f0160f9996fe8f938c567e2ad92b60_Value_7);
            ...
            SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
            {
                ...
                float4 _SampleTexture2D_d92f20fc369a4e729112b63bfa99ba34_RGBA_0 = SAMPLE_TEXTURE2D(
                    _Property_fe4efc6af5e74ff2963d75a0384f6298_Out_0.tex, _Property_fe4efc6af5e74ff2963d75a0384f6298_Out_0.samplerstate,
                    _Property_fe4efc6af5e74ff2963d75a0384f6298_Out_0.GetTransformedUV(IN.uv0.xy));
                ...
                SG_AdvancedDissolve_58cc1ed7edc36664e85cbe55fd29d527_float(0, float4(0, 0, 0, 1), _AdvancedDissolve_ca61051ac95648e2a739376452880eb5,
                                     _AdvancedDissolve_ca61051ac95648e2a739376452880eb5_Out_3);
                float _Add_203e8fa61ac540d7ade7dd61650cf263_Out_2;
                Unity_Add_float(_Property_5be4753bc2234d52a2df5a5d2b4fff4f_Out_0, _AdvancedDissolve_ca61051ac95648e2a739376452880eb5_Out_3,
                      _Add_203e8fa61ac540d7ade7dd61650cf263_Out_2);
                ...
                //UniversalForward
                AdvancedDissolveShaderGraph(IN.uv0.xy, IN.ObjectSpacePosition, IN.WorldSpacePosition, IN.AbsoluteWorldSpacePosition, IN.ObjectSpaceNormal,
                    IN.WorldSpaceNormal, 0, 1, surface.BaseColor, surface.Emission, surface.Alpha,
    ...
    _AdvancedDissolveShaderGraphFunctionCustomFunction_18f0160f9996fe8f938c567e2ad92b60_Value_7);
            ...
            SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
            {
              ...
              _AdvancedDissolve_ca61051ac95648e2a739376452880eb5_Out_3);
                ...
                //GBuffer
                AdvancedDissolveShaderGraph(IN.uv0.xy, IN.ObjectSpacePosition, IN.WorldSpacePosition, IN.AbsoluteWorldSpacePosition, IN.ObjectSpaceNormal,
        IN.WorldSpaceNormal, 0, 1, surface.BaseColor, surface.Emission, surface.Alpha, surface.AlphaClipThreshold);
        ...
        int _PassValue;
            ...
            SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
            {
                ...
                //ShadowCaster
                AdvancedDissolveShaderGraph(IN.uv0.xy, IN.ObjectSpacePosition, IN.WorldSpacePosition, IN.AbsoluteWorldSpacePosition, IN.ObjectSpaceNormal,
       IN.WorldSpaceNormal, 0, 1, surface.Alpha, surface.AlphaClipThreshold);
      ...
      _Property_6d35f866e3e7457cb788755ca206532e_Out_0, _AdvancedDissolveShaderGraphFunctionCustomFunction_18f0160f9996fe8f938c567e2ad92b60_Value_7);
        ...
        float4 _SelectionID;
                ...
                Bindings_AdvancedDissolve_58cc1ed7edc36664e85cbe55fd29d527_float IN, out float Out_3)
            {
                ...
                float _AdvancedDissolveShaderGraphFunctionCustomFunction_18f0160f9996fe8f938c567e2ad92b60_Value_7;
                AdvancedDissolveShaderGraphFunction_float((_UV_0af11090dff4968fbefbff780ab3f959_Out_0.xy), IN.ObjectSpacePosition, IN.WorldSpacePosition,
                                                IN.AbsoluteWorldSpacePosition, IN.ObjectSpaceNormal, IN.WorldSpaceNormal,
                                                _Property_2254a3efc4fcf082bc34b2ce5b131975_Out_0, _Property_6d35f866e3e7457cb788755ca206532e_Out_0,
                                                _AdvancedDissolveShaderGraphFunctionCustomFunction_18f0160f9996fe8f938c567e2ad92b60_Value_7);
                Out_3 = _AdvancedDissolveShaderGraphFunctionCustomFunction_18f0160f9996fe8f938c567e2ad92b60_Value_7;
            }
         ...
         _Add_203e8fa61ac540d7ade7dd61650cf263_Out_2);
                ...
                //SceneSelectionPass
                AdvancedDissolveShaderGraph(IN.uv0.xy, IN.ObjectSpacePosition, IN.WorldSpacePosition, IN.AbsoluteWorldSpacePosition, IN.ObjectSpaceNormal,
                                                                                                     IN.WorldSpaceNormal, 0, 1, surface.Alpha,
                                                                                                     surface.AlphaClipThreshold);
     ...
     _AdvancedDissolve_ca61051ac95648e2a739376452880eb5_Out_3);
        ...
        float3 NormalWS, float Custom_Cutout, float4 Custom_Color, out float Value)
            ...
            SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
            {
                ...
                //ScenePickingPass
                AdvancedDissolveShaderGraph(IN.uv0.xy, IN.ObjectSpacePosition, IN.WorldSpacePosition, IN.AbsoluteWorldSpacePosition, IN.ObjectSpaceNormal,
                                                        IN.WorldSpaceNormal, 0, 1, surface.BaseColor, surface.Alpha,
                                                        surface.AlphaClipThreshold);
